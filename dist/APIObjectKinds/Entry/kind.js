    ...
    validateSemantics: async (apiObject, etcd) => {
        ...
        Object.keys(apiObject.spec.values).forEach((key) => {
            ...
            if (!matchingAttribute) {
                throw new PreqlError_1.default('a16cfa1b-e48b-4911-b918-92861a241d7b', `Attribute '${key}' does not exist on Struct '${apiObject.spec.structName}' `
            ...
            if (attributeJSONType === 'integer') {
                ...
                if (!(Number.isSafeInteger(apiObject.spec.values[key]))) {
                    throw new PreqlError_1.default('2a22429e-8bd4-4f06-b01d-c114581fc922', `Number used in Attribute '${key}' in Entry '${apiObject.metadata.name}' `
            ...
            if (valueType === 'number') {
                if (datatype.spec.minimum && apiObject.spec.values[key] < datatype.spec.minimum) {
                    throw new PreqlError_1.default('b9d92500-6ac6-4a4f-80d6-dc63de8a1643', `Value of '${key}' for Entry '${apiObject.metadata.name}' was `
                ...
                if (datatype.spec.maximum && apiObject.spec.values[key] > datatype.spec.maximum) {
                    throw new PreqlError_1.default('15327242-05eb-4cd0-ab78-47f2525bc5b8', `Value of '${key}' for Entry '${apiObject.metadata.name}' was `
