...
const kind = {
    ...
    validateSemantics: async (apiObject, etcd) => {
        ...
        const childStructPath = `${apiObject.spec.databaseName}.${apiObject.spec.childStructName}`.toLowerCase();
        const parentStructPath = `${apiObject.spec.databaseName}.${apiObject.spec.parentStructName}`.toLowerCase();
